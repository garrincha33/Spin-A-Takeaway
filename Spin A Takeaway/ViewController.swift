...
class ViewController: UIViewController, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        spinWheelImageView.frame = CGRect(x: logoImageView.frame.midX - 120, y: logoImageView.frame.minY + 650, width: 250, height: 50)
    ...
    @objc func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        sayingLabel.center.y = circleView.center.y + 350
...
class SettingsViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Set the text color of the title label
        if self.traitCollection.userInterfaceStyle == .dark {
        ...
        // Set the text color of the detail label
        if self.traitCollection.userInterfaceStyle == .dark {
